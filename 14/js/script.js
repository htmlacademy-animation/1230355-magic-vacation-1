...
/***/ "./source/js/animation/animation-2d.js":
/*!*********************************************!*\
  !*** ./source/js/animation/animation-2d.js ***!
  \*********************************************/
/*! exports provided: default */
...
/***/ "./source/js/animation/seacalf-canvas-animation.js":
/*!*********************************************************!*\
  !*** ./source/js/animation/seacalf-canvas-animation.js ***!
  \*********************************************************/
/*! exports provided: default */
...
/* harmony import */ var _animation_animation_2d__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../animation/animation-2d */ "./source/js/animation/animation-2d.js");
...
class SeaCalfScene {
    ...
    initResizeListener() {
        window.addEventListener(`resize`, this.updateSceneSizing.bind(this));
    }
    updateSceneSizing() {
    ...
    initSnowFlakesAnimations() {
        this.animations.push(
            new _animation_animation_2d__WEBPACK_IMPORTED_MODULE_0__["default"]({
    ...
    initTraceAnimations() {
        this.animations.push(
            new _animation_animation_2d__WEBPACK_IMPORTED_MODULE_0__["default"]({
                func: (progress) => {
                    const progressReversed = 1 - progress;
                    this.trace.radius = 15 * progress;
                    this.trace.centerY = 55 - 15 * progressReversed;
                    this.trace.endX = 91 - 35 * progressReversed;
                    this.trace.endY = 49 - 12 * progressReversed;
                    this.trace.angle = 30 + 120 * progressReversed;
                    this.trace.deltasLength = 10 * progress;
                    this.trace.opacity = progress;
                },
                duration: 500,
                delay: 1200,
                easing: _helpers_easing__WEBPACK_IMPORTED_MODULE_1__["default"].easeInQuad,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _animation_seacalf_canvas_animation_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./../animation/seacalf-canvas-animation.js */ "./source/js/animation/seacalf-canvas-animation.js");
  ...
  if (results.length) {
    for (let i = 0; i < showResultEls.length; i++) {
      showResultEls[i].addEventListener(`click`, function () {
        ...
        if (target === `result`) {
          let SeaCalfCanvasAnimate = new _animation_seacalf_canvas_animation_js__WEBPACK_IMPORTED_MODULE_0__["default"]({
